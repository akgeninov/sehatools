<?php 
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM admin where id_admin = '$_GET[kode]'");
                ...
                <div class="form">
                        ...
                        <fieldset>
                            <table>
                                ...
                                <tr>
                                    <td>Password</td>
                                    <td> : </td>
                                    <td><input type="text" name="password" value="<?php echo $data['password']; ?>" disabled></td>
                                </tr>
                                <tr></tr>
                                <tr>
                                    <td>
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses'])){
                            ...
                            username = '$_POST[username]' WHERE id_admin = '$_GET[kode]'");

                            $status = "berhasil";
                        }

                        if($status == "berhasil"){
                            echo "<script> alert('Ubah data berhasil!'); window.location='tampilAdmin.php';</script>";
                        }
                    ?>
                </div>
            </div>
