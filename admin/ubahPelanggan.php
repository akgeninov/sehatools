<?php 
    ...
    if(isset($_GET['kode'])&&$_GET['aksi']=="hapus"){
        mysqli_query($koneksi, "DELETE FROM customers WHERE id_customer = '$_GET[kode]'");
                            ...
                            <?php
                                ...
                                while ($tampil = mysqli_fetch_array($ambil)){
                                    echo "
                                        <tr>
                                            <td>
                                                    <a href='formUbahPelanggan.php?kode=$tampil[id_customer]'>
                                                        <span class='icon-action'><i class='fa-solid fa-pen-to-square'></i></span>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href='?kode={$tampil['id_customer']}&aksi=hapus' 
                                            ...
                                            <td>$tampil[name_customer]</td>
                                            <td>$tampil[email]</td>
                                            <td>$tampil[phone]</td>
                                            <td>$tampil[shipping_address]</td>
                                            <td>$tampil[city]</td>
                                            <td>$tampil[postal_code]</td>
                                            <td>$tampil[county]</td>
                                        </tr>";
                                    $no++;
                                }
