<?php 
    ...
    if(isset($_GET['kode'])&&$_GET['aksi']=="hapus"){
        mysqli_query($koneksi, "DELETE FROM products WHERE id_product = '$_GET[kode]'");
                                ...
                                <?php
                                    ...
                                    while ($tampil = mysqli_fetch_array($ambil)){
                                        echo "
                                            <tr>
                                                <td>
                                                    <a href='formUbahProduk.php?kode=$tampil[id_product]'>
                                                        <span class='icon-action'><i class='fa-solid fa-pen-to-square'></i></span>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href='?kode={$tampil['id_product']}&aksi=hapus' 
                                                    onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">
                                                        <span class='icon-action'><i class='fa-solid fa-trash'></i></span>
                                                    </a>
                                                </td>
                                                <td>$no</td>
                                                <td>$tampil[id_product]</td>
                                                <td>$tampil[name_product]</td>
                                                <td>$tampil[quantity]</td>
                                                <td>$tampil[price]</td>
                                                <td>$tampil[category]</td>
                                                <td>$tampil[link_image]</td>
                                                <td>$tampil[description_product]</td>
                                                <td>$tampil[composition_product]</td>
                                                <td>$tampil[storage_instruction]</td>
                                                <td>$tampil[usage_instruction]</td>
                                            </tr>";
                                        $no++;
                                    }
                                ?>
