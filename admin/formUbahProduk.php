                ...
                <div class="form">
                        ...
                        <fieldset>
                            <table>
                                <tr>
                                    <td>Nama Produk</td>
                                    <td> : </td>
                                    <td><input type="text" name="name_prod" value="<?php echo $data['name_product']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>Kategori</td>
                                    <td> : </td>
                                ...
                                <tr>
                                    <td>Link Gambar</td>
                                    <td> : </td>
                                    <td><input type="text" name="link_img" value="<?php echo $data['link_image']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>Deskripsi Produk</td>
                                    <td> : </td>
                                    <td><input type="text" name="prod_desc" value="<?php echo $data['description_product']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>Komposisi</td>
                                    <td> : </td>
                                    <td><input type="text" name="composition" value="<?php echo $data['composition_product']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>Petunjuk Penggunaan</td>
                                    <td> : </td>
                                    <td><input type="text" name="usage" value="<?php echo $data['usage_instruction']; ?>"></td>
                                </tr>
                                <tr>
                                    <td>Petunjuk Penyimpanan</td>
                                    <td> : </td>
                                    <td><input type="text" name="storage" value="<?php echo $data['usage_instruction']; ?>"></td>
                                </tr>
                                <tr></tr>
                                <tr>
                                    <td>
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses'])){
                            ...
                            usage_instruction = '$_POST[usage]' WHERE id_product = '$_GET[kode]'");
