                        ...
                        <tbody>
                            ...
                            while ($tampil = mysqli_fetch_array($ambil)) {
                                ...
                                if (strtolower($tampil['status']) == "selesai") {
                                    ...
                                    $rowClass = " class='row-disabled' title='Pesanan dengan ID {$tampil['id_order']} sudah selesai dan tidak dapat diubah.'";
                                } else {
                                    $editBtn = "<a href='formUbahPesanan.php?kode=$tampil[id_order]'>
                                                    <span class='icon-action'><i class='fa-solid fa-pen-to-square'></i></span>
                                                </a>";
                                    $hapusBtn = "<a href='?kode={$tampil['id_order']}&aksi=hapus' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">
