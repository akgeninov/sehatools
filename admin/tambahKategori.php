                ...
                <div class="form">
                        ...
                        <fieldset>
                            <table>
                                <tr>
                                    <td>Nama Kategori</td>
                                    <td> : </td>
                                    <td><input type="text" name="name_cat" required></td>
                                </tr>
                                <tr>
                                    <td>Deskripsi</td>
                                    <td> : </td>
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses'])){
                            mysqli_query($koneksi, "INSERT INTO category set
                        ...
                        if($status == "berhasil"){
                            echo "<script> alert('Berhasil menambahkan data kategori'); window.location='tampilKategori.php';</script>";
                        }
                    ?>
                </div>
            </div>
