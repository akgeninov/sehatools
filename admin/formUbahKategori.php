<?php 
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM category where id_category = '$_GET[kode]'");
                ...
                <div class="form">
                        ...
                        <fieldset>
                            <table>
                                <tr>
                                    <td>Nama Kategori</td>
                                    <td> : </td>
                                    <td><input type="text" name="name_cat" value="<?php echo $data['name_category']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td>Deskripsi</td>
                                    <td> : </td>
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses'])){
                            $query = mysqli_query($koneksi, "UPDATE category set
                            name_category = '$_POST[name_cat]',
                            description = '$_POST[description]' WHERE id_category = '$_GET[kode]'");

                            $status = "berhasil";
                        }

                        if($status == "berhasil"){
                            echo "<script> alert('Ubah data berhasil!'); window.location='tampilKategori.php';</script>";
                        }
                    ?>
                </div>
            </div>
