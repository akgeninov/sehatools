<?php 
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM customers where id_customer = '$_GET[kode]'");
                ...
                <div class="form">
                        ...
                        <fieldset>
                            <table>
                                <tr>
                                    ...
                                    <td> : </td>
                                    <td><input type="text" name="name_cust" value="<?php echo $data['name_customer']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                    <td> : </td>
                                ...
                                <tr>
                                    ...
                                    <td> : </td>
                                    <td><input type="text" name="ship_add" value="<?php echo $data['shipping_address']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td>Kota</td>
                                    <td> : </td>
                                ...
                                <tr>
                                    <td>Kode Pos</td>
                                    <td> : </td>
                                    <td><input type="text" name="postal_code" value="<?php echo $data['postal_code']; ?>" required></td>
                                </tr>
                                <tr>
                                    <td>Provinsi</td>
                                    <td> : </td>
                                    <td><input type="text" name="county" value="<?php echo $data['county']; ?>" required></td>
                                </tr>
                                <tr></tr>
                                <tr>
                                    <td>
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses'])){
                            ...
                            name_customer = '$_POST[name_cat]',
                            email = '$_POST[description]',
                            phone = '$_POST[phone]',
                            shipping_address = '$_POST[ship_add]',
                            city = '$_POST[city]',
                            postal_code = '$_POST[postal_code]',
                            county = '$_POST[county]'  WHERE id_customer = '$_GET[kode]'");
